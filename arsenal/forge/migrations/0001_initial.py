# Generated by Django 4.1.3 on 2022-12-02 06:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter name of the armor', max_length=200, verbose_name='name')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=18, verbose_name='price')),
                ('buyer_wishes', tinymce.models.HTMLField(blank=True, help_text='Please, write all your wishes here', max_length=10000, null=True, verbose_name='buyer wishes')),
        ...
        migrations.AddField(
            model_name='armor',
            name='armor_type',
            field=models.ManyToManyField(help_text='Choose armors from this blacksmith', to='forge.armortype', verbose_name='armor(s)'),
        ),
        migrations.AddField(
            model_name='armor',
            name='blacksmith',
